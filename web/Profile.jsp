...
<div class="text">
    <h4>Приумножай свои капиталы с нами. Регистрируйся и присоединяйся к первой сотне списка Forbes.</h4>
        <table class="table">
            <thead>
            <tr>
                <th>Имя</th>
            ...
            <%
                ...
                for(Client client : list){
                    ...
                    out.println(client.getLastName());
                }
            %>
